...
# MAGIC
# MAGIC <img src="https://github.com/databricks-demos/dbdemos-resources/blob/main/images/product/chatbot-rag/llm-rag-self-managed-prep-0.png?raw=true" style="float: right; width: 500px; margin-left: 10px">
# MAGIC
...
# MAGIC - Compute embeddings (array&ltfloat&gt) representing our chunks with Databricks Foundation Models
...
# MAGIC
# MAGIC <img src="https://github.com/databricks-demos/dbdemos-resources/blob/main/images/product/chatbot-rag/llm-rag-self-managed-model-0.png?raw=true" style="float: right; width: 500px; margin-left: 10px">
# MAGIC
